...
Vopl3::Vopl3(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , force_clear_flags{vlSymsp->TOP.force_clear_flags}
...
VL_ATTR_COLD void Vopl3::trace(VerilatedVcdC* tfp, int levels, int options) {
    vl_fatal(__FILE__, __LINE__, __FILE__,"'Vopl3::trace()' called on model that was Verilated without --trace option");
}
