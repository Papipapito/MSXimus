// ============================================================================
//  iosys_bl616.v -- interfaz UART con el MCU BL616 (arquitectura TangCore)
//
//  ORIGEN: nand2mario/nestang, src/iosys/iosys_bl616.v  (GPL-3.0, igual que
//  este proyecto). Copiado con dos cambios minimos, marcados en el codigo:
//    1. kbd_data pasa de `input reg` a `output reg` (el original lo pilota).
//    2. --
//  El protocolo esta documentado en nand2mario/tangcore -> doc/dev.md.
// ============================================================================
...
(
    ...
    // Keyboard interface
    // MSXimus: en el original esto era `input reg` Y ADEMAS se le asigna
    // (linea del comando 0xc). Un input no se puede pilotar: es SALIDA.
